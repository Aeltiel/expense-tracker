...
export function App() {
  /*useSelector permet de lire dans le store. il s'agit d'une fonction qui prend
  store en paramètre et qui va chercher ensuite ce que tu veux dans ton index de store
  pour construire le reste, on peu regarder dans le redux dev tool
  */
